...
meta() %>%
  ...
  meta_social(
    ...
    image = "https://github.com/JauntyJJS/PyDataGlobal2021Talk/blob/main/images/screenshot-title.png",
    image_alt = paste(
      "Title slide of",
...
### Jeremy Selva [`r fa(name = "github")`](https://github.com/JauntyJJS) [`r fa(name = "linkedin")`](https://www.linkedin.com/in/jeremy-selva-085b9112a/)
